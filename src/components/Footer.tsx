        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-base md:text-lg">Gala de l'Immobilier</h3>
                <p className="text-yellow-400 text-xs md:text-sm">Africaine</p>
              </div>
            </div>
            <p className="text-gray-400 text-xs md:text-sm leading-relaxed">
              Célébrant l'innovation, l'immobilier et le leadership à travers l'Afrique.
            </p>
          </div>
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="space-y-2 md:space-y-3">
              ...
              <div className="flex items-center space-x-2 md:space-x-3">
                ...
                <span className="text-gray-400 text-xs md:text-sm break-all">contact@gala-immobilier.com</span>
              </div>
              <div className="flex items-center space-x-2 md:space-x-3">
        ...
        <div className="border-t border-yellow-500/20 mt-6 md:mt-8 pt-4 md:pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
            <p className="text-gray-400 text-xs md:text-sm text-center md:text-left">
              © 2025 Gala de l'Immobilier Africaine. Tous droits réservés.
            </p>
