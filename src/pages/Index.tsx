        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Célébrons ensemble les acteurs qui façonnent l'avenir de l'immobilier en Afrique
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">
              Merci à nos partenaires qui soutiennent l'immobilier africaine
            </p>
          </div>
  ...
  const renderNomines = () => {
    return (
      <div className="space-y-8 px-4 py-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-white mb-4">Tous les Nominés {selectedYear}</h1>
            <p className="text-xl text-gray-400">
              Découvrez tous les nominés avec leur catégorie
            </p>
          </div>
            ...
            <div key={category.id} className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {category.agencies && category.agencies.length > 0 ? (
                  ...
                  <p className="text-gray-500">Aucun nominé dans cette catégorie.</p>
                )}
              </div>
            </div>
          ))}
    ...
    <div className="space-y-8 px-4 py-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400">
            Explorez toutes les catégories de l'immobilier africaine
          </p>
        </div>
    ...
    <div className="space-y-8 px-4 py-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400">
            Découvrez nos partenaires qui soutiennent l'immobilier africaine
          </p>
        </div>
